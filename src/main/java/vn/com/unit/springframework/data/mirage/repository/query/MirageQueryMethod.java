...
import vn.com.unit.springframework.data.mirage.repository.support.MirageQueryExecutionConverters;
...
public class MirageQueryMethod extends QueryMethod {
	...
	private static Class<?> potentiallyUnwrapReturnTypeFor(Method method) {
		if (MirageQueryExecutionConverters.supports(method.getReturnType())) {
