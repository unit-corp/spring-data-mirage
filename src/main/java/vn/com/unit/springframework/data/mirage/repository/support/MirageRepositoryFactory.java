...
import vn.com.unit.springframework.data.mirage.repository.DefaultMirageRepository;
import vn.com.unit.springframework.data.mirage.repository.Identifiable;
import vn.com.unit.springframework.data.mirage.repository.IdentifiableMirageRepository;
import vn.com.unit.springframework.data.mirage.repository.NoSuchSqlResourceException;
import vn.com.unit.springframework.data.mirage.repository.query.MirageQueryLookupStrategy;
...
public class MirageRepositoryFactory extends RepositoryFactorySupport {
	...
	protected RepositoryMetadata getRepositoryMetadata(Class<?> repositoryInterface) {
		return MirageDefaultRepositoryMetadata.getMetadata(repositoryInterface);
	}
}
